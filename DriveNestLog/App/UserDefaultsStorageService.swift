...
final class UserDefaultsStorageService: StorageService {
    private let store = UserDefaults(suiteName: "group.drivenest.cache")!
    ...
    private enum Key {
        ...
        static let permGranted = "dn_perm_granted"
        static let permDenied = "dn_perm_denied"
        static let permDate = "dn_perm_date"
    }
    ...
    func savePermissions(_ permission: PermissionState) {
        ...
        if let date = permission.lastAskedDate {
